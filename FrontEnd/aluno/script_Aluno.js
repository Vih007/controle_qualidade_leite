// vih007/controle_qualidade_leite/controle_qualidade_leite-357fc0b8356288522c3cd4c70c666fdcaacf6773/FrontEnd/aluno/script_Aluno.js
...
  if (tbodyElement) {
    tbodyElement.innerHTML = '<tr><td colspan="9">Carregando dados...</td></tr>';
  }
...
        document.querySelector(tbodySelector).innerHTML = '<tr><td colspan="9">Falha ao carregar dados. Verifique a conexão com o servidor.</td></tr>';
      });
  }
}
...
// ... (continuação das funções de edição e exclusão)
